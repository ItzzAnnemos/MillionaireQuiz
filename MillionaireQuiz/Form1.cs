namespace MillionaireQuiz
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            list = new List<string> { "Атина", "Белград", "Софија", "Скопје" };
            q = new Question("Кој е главен град на Република Северна Македонија?", list, 3, "Easy");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else // Hard
            {
                ...
                {
                    // Risk: eliminate correct + one wrong
            ...
            // Disable the eliminated buttons
